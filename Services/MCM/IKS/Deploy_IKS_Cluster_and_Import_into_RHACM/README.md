...
To test deploy this service navigate to Automate Infrastructure > Manage Services > IBM Cloud Kubernetes Service Cluster with RHACM import. Fill the following input parameters and deploy the service.

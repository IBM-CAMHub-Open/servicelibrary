...
To deploy this service from IBM Cloud Automation Manager navigate to Library > Services > Amazon Elastic Kubernetes Service Cluster with RHACM import. Fill the following input parameters and deploy the service.

...
To test deploy this service navigate to Automate Infrastructure > Manage Services > Azure Kubernetes Service Cluster > Select a version > Test deploy. 
Fill the following input parameters and deploy the service.
